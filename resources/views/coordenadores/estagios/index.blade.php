                    ...
                    <table class="table table-striped projects">
                        ...
                        <tr>
                            ...
                            <td class="project-actions text-right">
                                <a class="btn btn-primary btn-sm" href="{{route('coordenador.estagios.tarefas.index',$estagio)}}">
                                    <i class="fas fa-folder">
                                    </i>
                                    Tarefas
                                </a>
                                <a class="btn btn-info btn-sm" href="{{route('coordenador.estagios.show',$estagio)}}">
